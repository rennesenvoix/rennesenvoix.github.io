      ...
      <main className="relative flex-1 pt-16 md:pt-20">
        ...
        <div className="container-wide relative py-20 md:py-28">
          ...
          <div className="mt-14 grid gap-10 lg:grid-cols-[12rem_minmax(0,1fr)]">
            <nav className="sticky top-20 z-20 self-start rounded-xl border border-border bg-background/95 p-4 shadow-sm backdrop-blur lg:top-28" aria-label="Éditions de la programmation">
