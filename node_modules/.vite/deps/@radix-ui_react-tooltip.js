...
import {
  useId
} from "./chunk-FSKBYUWL.js";
import {
  DismissableLayer,
  Portal,
  Root2 as Root
} from "./chunk-IDSBXQIO.js";
import {
  Presence,
  Primitive,
...
var TooltipProvider = __name4((props) => {
  const {
    __scopeTooltip,
...
var Tooltip = __name4((props) => {
  ...
  const [contentIdState, setContentId] = React5.useState(void 0);
...
var TooltipTrigger = React5.forwardRef(
  __name4(function TooltipTrigger2(props, forwardedRef) {
...
var TooltipPortal = __name4((props) => {
...
var TooltipContent = React5.forwardRef(
  __name4(function TooltipContent2(props, forwardedRef) {
...
var TooltipContentHoverable = React5.forwardRef(__name4(function TooltipContentHoverable2(props, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  ...
  React5.useEffect(() => {
    if (trigger && content) {
      const handleTriggerLeave = __name4((event) => handleCreateGraceArea(event, content), "handleTriggerLeave");
      const handleContentLeave = __name4((event) => handleCreateGraceArea(event, trigger), "handleContentLeave");
  ...
  React5.useEffect(() => {
    if (pointerGraceArea) {
      const handleTrackPointerGrace = __name4((event) => {
...
var TooltipContentImpl = React5.forwardRef(
  ...
  __name4(function TooltipContentImpl2(props, forwardedRef) {
    const {
      __scopeTooltip,
      children,
    ...
    React5.useEffect(() => {
      if (context.trigger) {
        const handleScroll = __name4((event) => {
...
var TooltipArrow = React5.forwardRef(
  __name4(function TooltipArrow2(props, forwardedRef) {
...
__name4(getExitSideFromRect, "getExitSideFromRect");
...
__name4(getPaddedExitPoints, "getPaddedExitPoints");
...
__name4(getPointsFromRect, "getPointsFromRect");
...
__name4(isPointInPolygon, "isPointInPolygon");
...
__name4(getHullPresorted, "getHullPresorted");
